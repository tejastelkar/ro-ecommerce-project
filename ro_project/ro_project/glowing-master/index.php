...
<body id="top">
  ...
  <header class="header">
    ...
    <div class="header-top" data-header>
      <div class="container">
        ...
        <a href="#" class="logo">
          <img src="./assets/images/logo.jpg" width="179" height="40" alt="Glowing">
        </a>
  ...
  <div class="sidebar">
    <div class="mobile-navbar" data-navbar>
      ...
      <div class="wrapper">
        <a href="#" class="logo">
          <img src="./assets/images/logo.png" width="179" height="26" alt="RO-logo">
        </a>
              ...
              <div class="shop-card">
                ...
                <div class="card-banner img-holder" style="--width: 540; --height: 720;">
                  ...
                  <div class="card-actions">
                    ...
                    <a href="../signup.php" class="action-btn" aria-label="add to cart">
                      <ion-icon name="bag-handle-outline" aria-hidden="true"></ion-icon>
                    </a>
                    
                    <a href="../signup.php" class="action-btn" aria-label="add to wishlist">
